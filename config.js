...
const defaultOwner = '254757194739';
...
//
global.botname = process.env.BOTNAME || 'mesh';
global.pairingNumber = process.env.BOT_NUMBER || '254798216098';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'session id';  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['254757194739', '254798216098']
